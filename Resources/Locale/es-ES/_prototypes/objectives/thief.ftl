...
ent-TropicoStealObjective = { ent-BaseThiefStealAnimalObjective }
    .desc = { ent-BaseThiefStealAnimalObjective.desc }
ent-EscapeThiefShuttleObjective = Escapa al Mando Central con vida y sin estar esposado.
    .desc = No querrás que nadie descubra tus actividades ilegales, ¿verdad?
