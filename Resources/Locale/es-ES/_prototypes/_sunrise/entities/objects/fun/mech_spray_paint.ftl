ent-MechPaintBase = pintura en espray para mecas
    .desc = Un bote de pintura en espray para mecas.
...
ent-MechPaintGygaxOld = { ent-MechPaintBase }
    .suffix = Gygax, antiguo
    .desc = { ent-MechPaintBase.desc }
ent-MechPaintDurandOld = { ent-MechPaintBase }
    .suffix = Durand, antiguo
    .desc = { ent-MechPaintBase.desc }
