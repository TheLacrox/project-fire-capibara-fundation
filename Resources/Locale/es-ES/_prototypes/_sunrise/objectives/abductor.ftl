...
ent-AbductorKillObjective = { ent-BaseAbductorVictimObjective }
    .desc = Tengo que encontrar y matar a esta persona.
ent-AbductorEscapeShuttleObjective = Escapa al Mando Central con vida y sin estar esposado.
    .desc = Quiero ser LIBREEE.
