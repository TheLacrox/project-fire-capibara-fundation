...
admin-notes-unknown-server = Unknown
admin-notes-unknown-round = Unknown round
admin-notes-round = Round {$round}
admin-notes-unknown-role = unknown role
admin-notes-for-duration = for {$duration}
