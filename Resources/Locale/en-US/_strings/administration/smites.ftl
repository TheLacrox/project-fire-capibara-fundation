...
admin-smite-random-death-irradiate-self = 3.6 roentgen, not great, not terrible...
admin-smite-random-death-scorched-self = You smell gas. Smoking kills...
admin-smite-random-death-shock-self = You trip on a loose wire...
admin-smite-random-death-vomit-self = You start vomiting uncontrollably...
admin-smite-random-death-bluespace-self = You feel a strange sensation as you are teleported away...
admin-smite-random-death-bleed-self = You start bleeding profusely...
...
admin-trick-spin-description = Makes the object spin.
admin-trick-set-scale-description = Changes the object's visual scale.
